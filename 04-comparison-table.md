...
| **Cost / conv (Scenario A — 4 turns)** | $0.00143 | $0.08759 | $0.01566 | N/A |
| **Cost / conv (Scenario B — 7 turns)** | $0.00175 | $0.10676 | $0.01916 | N/A |
| **Monthly A** (300 conv/day × 30) | $12.90 | $788.29 | $140.90 | N/A |
| **Monthly B** (1,200 conv/day × 30) | $63.05 | $3,843.27 | $689.73 | N/A |
| **vs human $4,500/mo (A)** | rẻ 348.84× | rẻ 5.71× | rẻ 31.94× | N/A |
| **vs human $18,000/mo (B)** | rẻ 285.47× | rẻ 4.68× | rẻ 26.10× | N/A |
| **Savings % (A)** | 99.71% | 82.48% | 96.87% | N/A |
| **Savings % (B)** | 99.65% | 78.65% | 96.17% | N/A |
...
```text
Rẻ nhất: Budget Bot — monthly B = $63.05
Đắt nhất: Premium Concierge — monthly B = $3,843.27
Chênh: khoảng 60.95× lần
```

### Câu 2 — Knob nào ảnh hưởng cost nhiều nhất?

```text
Knob ảnh hưởng cost mạnh nhất là model tier. Chỉ riêng việc chuyển từ GPT-4o-mini sang GPT-5.5 và thêm classifier LLM đã đẩy cost từ $63.05/tháng lên $3,843.27/tháng ở Scenario B, tức tăng hơn 60×. History và web search cũng làm cost tăng, nhưng mức tăng của chúng nhỏ hơn nhiều so với việc đổi từ cheap sang premium model.
```

### Câu 3 — Tại sao Scenario B không đắt ×4 lần Scenario A?

```text
Scenario B có volume cao hơn 4× và số turn dài hơn, nhưng tỉ lệ Booking + Complaint cũng tăng lên 45%, trong khi hai intent này gần như không tốn generation cost vì được handoff sang người. Vì vậy monthly cost tăng mạnh nhưng không tăng đúng theo công thức 4× volume × 1.75× turns.
```
